...
class KhipsterVueApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes khipsterVue.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KhipsterVueApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KhipsterVueApp::class.java)
